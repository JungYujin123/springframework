...
public class ApplicationContextInitListener implements ServletContextListener {
   ...
   public void contextInitialized(ServletContextEvent ctxEvent) {
      ...
      try {
         ...
         //application-context.xml 내용 존재 여부 
...
//         System.out.println(root.getTagName());
         ...
         //ApplicationContext container에 넣기 위해 부름
         ...
         for (int i =0; i<beans.getLength(); i++) {
            ...
            if (bean.getNodeType() == Node.ELEMENT_NODE ) {
               ...
               //컨테이너에 application-context.xml 내용 넣음
            ...
            if ( bean.getNodeType()== Node.ELEMENT_NODE) {
               ...
               for(int j =0; j< properties.getLength(); j++) {
                  ...
                  if(property.getNodeType()== Node.ELEMENT_NODE) {
                    ...
                    // property name에 set 붙이기 - 
                     String setMethodName = "set" + name.substring(0,1).toUpperCase()+name.substring(1);
                     
                     
                     //MenuServiceImpl에서 확인
                     ...
                     if(methods!=null) for (Method method : methods) {
                        //의존성 여부 확인
                    	 // application-context.xml의 property 아이디, ref 확인해서 setSqlSessionFactory, setMenuDAO 메소드를실행
