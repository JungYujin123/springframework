...
public class FileDownloadResolver {
	...
	public static void sendFile(String fileName, String savePath, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
